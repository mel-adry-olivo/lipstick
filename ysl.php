        ...
        <section class="section shop" id="all-products" aria-label="all-products" data-section>
          <div class="container">
            <div class="title-wrapper">
              <h2 class="h2 section-title">Yves Saint Laurent (YSL)</h2>
              ...
              <li class="scrollbar-item">
                <div class="shop-card">
                  ...
                  <div class="card-content">
                    ...
                    <h3>
                      <a href="product-detail.html?id=65" class="card-title">YSL Lightly Tinted</a>
                    </h3>
                    <div class="card-rating">
                      <div class="rating-wrapper" aria-label="4-star rating">
                        <ion-icon name="star" aria-hidden="true"></ion-icon>
              ...
              <li class="scrollbar-item">
                <div class="shop-card">
                  ...
                  <div class="card-content">
                    ...
                    <h3>
                      <a href="product-detail.html?id=51" class="card-title">YSL Soft Stain</a>
                    </h3>
                    <div class="card-rating">
                      <div class="rating-wrapper" aria-label="4-star rating">
                        <ion-icon name="star" aria-hidden="true"></ion-icon>
              ...
              <li class="scrollbar-item">
                <div class="shop-card">
                  ...
                  <div class="card-content">
                    ...
                    <h3>
                      <a href="product-detail.html?id=34" class="card-title">YSL Flirty Gloss</a>
                    </h3>
                    <div class="card-rating">
                      <div class="rating-wrapper" aria-label="4-star rating">
                        <ion-icon name="star" aria-hidden="true"></ion-icon>
              ...
              <li class="scrollbar-item">
                <div class="shop-card">
                  ...
                  <div class="card-content">
                    ...
                    <h3>
                      <a href="product-detail.html?id=79" class="card-title">YSL Cream Lipstick</a>
                    </h3>
                    <div class="card-rating">
                      <div class="rating-wrapper" aria-label="4-star rating">
                        <ion-icon name="star" aria-hidden="true"></ion-icon>
              ...
              <li class="scrollbar-item">
                <div class="shop-card">
                  ...
                  <div class="card-content">
                    ...
                    <h3>
                      <a href="product-detail.html?id=112" class="card-title">YSL Crayon Kiss</a>
                    </h3>
                    <div class="card-rating">
                      <div class="rating-wrapper" aria-label="5-star rating">
                        <ion-icon name="star" aria-hidden="true"></ion-icon>
