        ...
        >
          <div class="container">
            <div class="title-wrapper">
              <h2 class="h2 section-title">Creamy Lipsticks</h2>
            ...
            <ul class="has-scrollbar">
              ...
              <li class="scrollbar-item">
                <div class="shop-card">
                  ...
                  >
                    <img
                      src="images/creamy/AVON Dreamy Cream.jpg"
                      width="540"
                      height="720"
                      loading="lazy"
                  ...
                  <div class="card-content">
                    ...
                    <h3>
                      <a href="product-detail.html?id=77" class="card-title"
                        >Dreamy Cream Lipstick</a
                      >
                    </h3>
                    <div class="card-rating">
              ...
              <li class="scrollbar-item">
                <div class="shop-card">
                  ...
                  >
                    <img
                      src="images/creamy/AVON Dreamy Smooth.jpg"
                      width="540"
                      height="720"
                      loading="lazy"
                  ...
                  <div class="card-content">
                    ...
                    <h3>
                      <a href="product-detail.html?id=78" class="card-title"
                        >AVON Dreamy Smooth Lipstick</a
                      >
                    </h3>
                    <div class="card-rating">
                      <div class="rating-wrapper" aria-label="5-star rating">
              ...
              <li class="scrollbar-item">
                <div class="shop-card">
                  ...
                  >
                    <img
                      src="images/creamy/NARS Creamy Caress.jpg"
                      width="540"
                      height="720"
                      loading="lazy"
                  ...
                  <div class="card-content">
                    ...
                    <h3>
                      <a href="product-detail.html?id=80" class="card-title"
                        >NARS Creamy Caress Lipstick</a
                      >
                    </h3>
                    <div class="card-rating">
                      <div class="rating-wrapper" aria-label="4-star rating">
                    ...
                    <div class="color-shades">
                      ...
                      <div class="color-options">
                        <div class="color-swatch-container">
                          <span
                            class="color-swatch"
                            style="background-color: #b62046"
                            aria-label="Coral Blush"
                          ></span>
                          <span class="color-tooltip">Coral Blush</span>
                        </div>
                        <div class="color-swatch-container">
                          <span
                            class="color-swatch"
                            style="background-color: #ff1744"
                            aria-label="Berry Pop"
                          ></span>
                          <span class="color-tooltip">Berry Pop</span>
                        </div>
                        <div class="color-swatch-container">
                          <span
                            class="color-swatch"
                          ...
                          ></span>
                          <span class="color-tooltip">Cocoa Bliss</span>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <ul class="has-scrollbar">
              ...
              <li class="scrollbar-item">
                <div class="shop-card">
                  ...
                  >
                    <img
                      src="images/creamy/DIOR Creamy Delight.jpg"
                      width="540"
                      height="720"
                      loading="lazy"
                  ...
                  <div class="card-content">
                    ...
                    <h3>
                      <a href="product-detail.html?id=81" class="card-title"
                        >DIOR Creamy Delight Lipstick</a
                      >
                    </h3>
                    <div class="card-rating">
                      <div class="rating-wrapper" aria-label="4-star rating">
                    ...
                    <div class="color-shades">
                      ...
                      <div class="color-options">
                        <div class="color-swatch-container">
                          <span
                            class="color-swatch"
                            style="background-color: #ff1f4c"
                            aria-label="Scarlet Crush"
                          ></span>
                          <span class="color-tooltip">Scarlet Crush</span>
                        </div>
                        <div class="color-swatch-container">
                          <span
                            class="color-swatch"
                          ...
                          ></span>
                          <span class="color-tooltip">Peachy Pink</span>
                        </div>
                        <div class="color-swatch-container">
                          <span
                            class="color-swatch"
                            style="background-color: #a0522d"
                            aria-label="Cinnamon Spice"
                          ></span>
                          <span class="color-tooltip">Cinnamon Spice</span>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <li class="scrollbar-item">
                <div class="shop-card">
                  ...
                  >
                    <img
                      src="images/creamy/AVON Creamy Indulgence.jpg"
                      width="540"
                      height="720"
                      loading="lazy"
                      alt="Classic Red Lipstick"
                  ...
                  <div class="card-content">
                    ...
                    <h3>
                      <a href="product-detail.html?id=82" class="card-title"
                        >AVON Creamy Indulgence Lipstick</a
                      >
                    </h3>
                    <div class="card-rating">
                      <div class="rating-wrapper" aria-label="5-star rating">
                      ...
                      <div class="color-options">
                        <div class="color-swatch-container">
                          <span
                            ...
                            aria-label="Rosy Rouge"
                          ></span>
                          <span class="color-tooltip">Rosy Rouge</span>
                        </div>
                        <div class="color-swatch-container">
                          <span
                            class="color-swatch"
                            style="background-color: #ff007f"
                            aria-label="Fuchsia Crush"
                          ></span>
                          <span class="color-tooltip">Fuchsia Crush</span>
                        </div>
                        <div class="color-swatch-container">
                          <span
                            class="color-swatch"
                            style="background-color: #cd853f"
                            aria-label="Toffee Cream"
                          ></span>
                          <span class="color-tooltip">Toffee Cream</span>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <li class="scrollbar-item">
                <div class="shop-card">
                  ...
                  >
                    <img
                      src="images/creamy/AVON Divine Comfort.jpg"
                      width="540"
                      height="720"
                      loading="lazy"
                      alt="Berry Lipstick"
                  ...
                  <div class="card-content">
                    ...
                    <h3>
                      <a href="product-detail.html?id=83" class="card-title"
                        >AVON Divine Comfort Lipstick</a
                      >
                    </h3>
                    <div class="card-rating">
                      <div class="rating-wrapper" aria-label="4-star rating">
              ...
              <li class="scrollbar-item">
                <div class="shop-card">
                  ...
                  >
                    <img
                      src="images/creamy/YSL Rich Embrace.jpg"
                      width="540"
                      height="720"
                      loading="lazy"
                  ...
                  <div class="card-content">
                    ...
                    <h3>
                      <a href="product-detail.html?id=85" class="card-title"
                        >YSL Rich Embrace Lipstick</a
                      >
                    </h3>
                    <div class="card-rating">
                      <div class="rating-wrapper" aria-label="4-star rating">
            ...
            <ul class="has-scrollbar">
              ...
              <li class="scrollbar-item">
                <div class="shop-card">
                  ...
                  >
                    <img
                      src="images/creamy/MAC Silken Richness.jpg"
                      width="540"
                      height="720"
                      loading="lazy"
                  ...
                  <div class="card-content">
                    ...
                    <h3>
                      <a href="product-detail.html?id=86" class="card-title"
                        >MAC Silken Richness Lipstick</a
                      >
                    </h3>
                    <div class="card-rating">
                      <div class="rating-wrapper" aria-label="5-star rating">
              ...
              <li class="scrollbar-item">
                <div class="shop-card">
                  ...
                  >
                    <img
                      src="images/creamy/MAC Silky Smooth.jpg"
                      width="540"
                      height="720"
                      loading="lazy"
                  ...
                  <div class="card-content">
                    ...
                    <h3>
                      <a href="product-detail.html?id=87" class="card-title"
                        >MAC Silky Smooth Lipstick</a
                      >
                    </h3>
                    <div class="card-rating">
                      <div class="rating-wrapper" aria-label="4-star rating">
              ...
              <li class="scrollbar-item">
                <div class="shop-card">
                  ...
                  >
                    <img
                      src="images/creamy/YSL Smooth Operator.jpg"
                      width="540"
                      height="720"
                      loading="lazy"
                  ...
                  <div class="card-content">
                    ...
                    <h3>
                      <a href="product-detail.html?id=88" class="card-title"
                        >YSL Smooth Operator Lipstick</a
                      >
                    </h3>
                    <div class="card-rating">
                      <div class="rating-wrapper" aria-label="5-star rating">
              ...
              <li class="scrollbar-item">
                <div class="shop-card">
                  ...
                  >
                    <img
                      src="images/creamy/YSL Velvet Kisses.jpg"
                      width="540"
                      height="720"
                      loading="lazy"
                      alt="Coral Kiss Lipstick"
                  ...
                  <div class="card-content">
                    ...
                    <h3>
                      <a href="product-detail.html?id=90" class="card-title"
                        >YSL Velvet Kisses Lipstick</a
                      >
                    </h3>
                    <div class="card-rating">
                      <div class="rating-wrapper" aria-label="5-star rating">
