        ...
        >
          <div class="container">
            <div class="title-wrapper">
              <h2 class="h2 section-title">Satin Lipsticks</h2>
            ...
            <ul class="has-scrollbar">
              ...
              <li class="scrollbar-item">
                <div class="shop-card">
                  ...
                  >
                    <img
                      src="images/Satin/Avon Alluring Shine.jpg"
                      width="540"
                      height="720"
                      loading="lazy"
                  ...
                  <div class="card-content">
                    ...
                    <h3>
                      <a href="product-detail.html?id=19" class="card-title"
                        >Avon Alluring Shine Lipstick</a
                      >
                    </h3>
                    <div class="card-rating">
                      <div class="rating-wrapper" aria-label="4-star rating">
              ...
              <li class="scrollbar-item">
                <div class="shop-card">
                  ...
                  >
                    <img
                      src="images/Satin/Avon Divine Smooth.jpg"
                      width="540"
                      height="720"
                      loading="lazy"
                  ...
                  <div class="card-content">
                    ...
                    <h3>
                      <a href="product-detail.html?id=20" class="card-title"
                        >Avon Divine Smooth Lipstick</a
                      >
                    </h3>
                    <div class="card-rating">
                      <div class="rating-wrapper" aria-label="4-star rating">
            ...
            <ul class="has-scrollbar">
              ...
              <li class="scrollbar-item">
                <div class="shop-card">
                  ...
                  >
                    <img
                      src="images/Satin/Avon Dreamy Delight.jpg"
                      width="540"
                      height="720"
                      loading="lazy"
                  ...
                  <div class="card-content">
                    ...
                    <h3>
                      <a href="product-detail.html?id=21" class="card-title"
                        >Avon Dreamy Delight Lipstick</a
                      >
                    </h3>
                    <div class="card-rating">
                      <div class="rating-wrapper" aria-label="4-star rating">
              ...
              <li class="scrollbar-item">
                <div class="shop-card">
                  ...
                  >
                    <img
                      src="images/Satin/MAC Enchanted Elegance.jpg"
                      width="540"
                      height="720"
                      loading="lazy"
                      alt="Classic Red Lipstick"
                  ...
                  <div class="card-content">
                    ...
                    <h3>
                      <a href="product-detail.html?id=22" class="card-title"
                        >MAC Enchanted Elegance Lipstick</a
                      >
                    </h3>
                    <div class="card-rating">
                      <div class="rating-wrapper" aria-label="5-star rating">
              ...
              <li class="scrollbar-item">
                <div class="shop-card">
                  ...
                  >
                    <img
                      src="images/Satin/NARS Glamour Kiss.jpg"
                      width="540"
                      height="720"
                      loading="lazy"
                      alt="Berry Lipstick"
                  ...
                  <div class="card-content">
                    ...
                    <h3>
                      <a href="product-detail.html?id=23" class="card-title"
                        >NARS Glamour Kiss Lipstick</a
                      >
                    </h3>
                    <div class="card-rating">
                      <div class="rating-wrapper" aria-label="4-star rating">
                    ...
                    <div class="color-shades">
                      ...
                      <div class="color-options">
                        <div class="color-swatch-container">
                          <span
                            class="color-swatch"
                            style="background-color: #ac5422ab"
                            aria-label="Brown"
                          ></span>
              ...
              <li class="scrollbar-item">
                <div class="shop-card">
                  ...
                  >
                    <img
                      src="images/Satin/NARS Kiss of Satin.jpg"
                      width="540"
                      height="720"
                      loading="lazy"
                      alt="Nude Lipstick"
                  ...
                  <div class="card-content">
                    ...
                    <h3>
                      <a href="product-detail.html?id=24" class="card-title"
                        >NARS Kiss of Satin Lipstick</a
                      >
                    </h3>
                    <div class="card-rating">
              ...
              <li class="scrollbar-item">
                <div class="shop-card">
                  ...
                  >
                    <img
                      src="images/Satin/YSL Luxurious Luster.jpg"
                      width="540"
                      height="720"
                      loading="lazy"
                  ...
                  <div class="card-content">
                    ...
                    <h3>
                      <a href="product-detail.html?id=25" class="card-title"
                        >YSL Luxurious Luster Lipstick</a
                      >
                    </h3>
                    <div class="card-rating">
                      <div class="rating-wrapper" aria-label="4-star rating">
            ...
            <ul class="has-scrollbar">
              ...
              <li class="scrollbar-item">
                <div class="shop-card">
                  ...
                  >
                    <img
                      src="images/Satin/MAC Radiant Glow.jpg"
                      width="540"
                      height="720"
                      loading="lazy"
                  ...
                  <div class="card-content">
                    ...
                    <h3>
                      <a href="product-detail.html?id=27" class="card-title"
                        >MAC Radiant Glow Lipstick</a
                      >
                    </h3>
                    <div class="card-rating">
                      <div class="rating-wrapper" aria-label="4-star rating">
              ...
              <li class="scrollbar-item">
                <div class="shop-card">
                  ...
                  <div class="card-content">
                    ...
                    <h3>
                      <a href="product-detail.html?id=30" class="card-title"
                        >Dior Silken Spice Lipstick</a
                      >
                    </h3>
                    <div class="card-rating">
