        ...
        >
          <div class="container">
            <div class="title-wrapper">
              <h2 class="h2 section-title">Lipstain</h2>
            ...
            <ul class="has-scrollbar">
              ...
              <li class="scrollbar-item">
                <div class="shop-card">
                  ...
                  >
                    <img
                      src="images/lipstain/Avon Whispering Rose.jpg"
                      width="540"
                      height="720"
                      loading="lazy"
                  ...
                  <div class="card-content">
                    ...
                    <h3>
                      <a href="product-detail.html?id=46" class="card-title"
                        >Avon Whispering Rose Lipstain</a
                      >
                    </h3>
              ...
              <li class="scrollbar-item">
                <div class="shop-card">
                  ...
                  >
                    <img
                      src="images/lipstain/Maybelline Sunkissed Glow.jpg"
                      width="540"
                      height="720"
                      loading="lazy"
                  ...
                  <div class="card-content">
                    ...
                    <h3>
                      <a href="product-detail.html?id=48" class="card-title"
                        >Maybelline Sunkissed Glow Lipstain</a
                      >
                    </h3>
                    <div class="card-rating">
                      <div class="rating-wrapper" aria-label="5-star rating">
                    ...
                    <div class="color-shades">
                      ...
                      <div class="color-options">
                        ...
                        <div class="color-swatch-container">
                          ...
                          ></span>
                          <span class="color-tooltip">Blueberry Blast</span>
                        </div>
                        <div class="color-swatch-container">
                          <span
                            class="color-swatch"
              ...
              <li class="scrollbar-item">
                <div class="shop-card">
                  ...
                  >
                    <img
                      src="images/lipstain/Avon Subtle Charm.jpg"
                      width="540"
                      height="720"
                      loading="lazy"
                  ...
                  <div class="card-content">
                    ...
                    <h3>
                      <a href="product-detail.html?id=49" class="card-title"
                        >Avon Subtle Charm Lipstain</a
                      >
                    </h3>
                    <div class="card-rating">
                      <div class="rating-wrapper" aria-label="4-star rating">
              ...
              <li class="scrollbar-item">
                <div class="shop-card">
                  ...
                  >
                    <img
                      src="images/lipstain/Dior Stained Romance.jpg"
                      width="540"
                      height="720"
                      loading="lazy"
                  ...
                  <div class="card-content">
                    ...
                    <h3>
                      <a href="product-detail.html?id=50" class="card-title"
                        >Dior Stained Romance</a
                      >
                    </h3>
                    <div class="card-rating">
                      <div class="rating-wrapper" aria-label="4-star rating">
            ...
            <ul class="has-scrollbar">
              ...
              <li class="scrollbar-item">
                <div class="shop-card">
                  ...
                  >
                    <img
                      src="images/lipstain/YSL  Soft Stain.jpg"
                      width="540"
                      height="720"
                      loading="lazy"
                  ...
                  <div class="card-content">
                    ...
                    <h3>
                      <a href="product-detail.html?id=51" class="card-title"
                        >YSL Soft Stain</a
                      >
                    </h3>
                    <div class="card-rating">
                    ...
                    <div class="color-shades">
                      ...
                      <div class="color-options">
                        ...
                        <div class="color-swatch-container">
                          <span
                            class="color-swatch"
                            style="background-color: #63040c"
                            aria-label="Maroon Glow"
                          ></span>
                          <span class="color-tooltip">Maroon Glow</span>
                        </div>
                        <div class="color-swatch-container">
                          <span
                            class="color-swatch"
              ...
              <li class="scrollbar-item">
                <div class="shop-card">
                  ...
                  >
                    <img
                      src="images/lipstain/YSL Petal Soft.jpg"
                      width="540"
                      height="720"
                      loading="lazy"
                      alt="Classic Red Lipstick"
                  ...
                  <div class="card-content">
                    ...
                    <h3>
                      <a href="product-detail.html?id=52" class="card-title"
                        >YSL Petal Soft Lipstain</a
                      >
                    </h3>
                    <div class="card-rating">
                      <div class="rating-wrapper" aria-label="5-star rating">
              ...
              <li class="scrollbar-item">
                <div class="shop-card">
                  ...
                  >
                    <img
                      src="images/lipstain/DIOR Natural Flush.jpg"
                      width="540"
                      height="720"
                      loading="lazy"
                      alt="Berry Lipstick"
                  ...
                  <div class="card-content">
                    ...
                    <h3>
                      <a href="product-detail.html?id=53" class="card-title"
                        >DIOR Natural Flush Lipstain</a
                      >
                    </h3>
                    <div class="card-rating">
                      <div class="rating-wrapper" aria-label="4-star rating">
              ...
              <li class="scrollbar-item">
                <div class="shop-card">
                  ...
                  >
                    <img
                      src="images/lipstain/NARS Lasting Impression.jpg"
                      width="540"
                      height="720"
                      loading="lazy"
                      alt="Nude Lipstick"
                  ...
                  <div class="card-content">
                    ...
                    <h3>
                      <a href="product-detail.html?id=54" class="card-title"
                        >NARS Lasting ImpressionLipstain</a
                      >
                    </h3>
                    <div class="card-rating">
              ...
              <li class="scrollbar-item">
                <div class="shop-card">
                  ...
                  >
                    <img
                      src="images/lipstain/Maybelline Kissed by Nature.jpg"
                      width="540"
                      height="720"
                      loading="lazy"
                  ...
                  <div class="card-content">
                    ...
                    <h3>
                      <a href="product-detail.html?id=55" class="card-title"
                        >Maybelline Kissed by Nature Lipstain</a
                      >
                    </h3>
                    <div class="card-rating">
                      <div class="rating-wrapper" aria-label="4-star rating">
            ...
            <ul class="has-scrollbar">
              ...
              <li class="scrollbar-item">
                <div class="shop-card">
                  ...
                  >
                    <img
                      src="images/lipstain/Avon Gentle Kiss.jpg"
                      width="540"
                      height="720"
                      loading="lazy"
                  ...
                  <div class="card-content">
                    ...
                    <h3>
                      <a href="product-detail.html?id=56" class="card-title"
                        >Avon Gentle Kiss Lipstain</a
                      >
                    </h3>
                    <div class="card-rating">
                      <div class="rating-wrapper" aria-label="5-star rating">
              ...
              <li class="scrollbar-item">
                <div class="shop-card">
                  ...
                  >
                    <img
                      src="images/lipstain/Dior Effortless Elegance.jpg"
                      width="540"
                      height="720"
                      loading="lazy"
                  ...
                  <div class="card-content">
                    ...
                    <h3>
                      <a href="product-detail.html?id=57" class="card-title"
                        >Effortless Elegance Lipstain</a
                      >
                    </h3>
                    <div class="card-rating">
                      <div class="rating-wrapper" aria-label="4-star rating">
              ...
              <li class="scrollbar-item">
                <div class="shop-card">
                  ...
                  >
                    <img
                      src="images/lipstain/NARS Blooming Bliss.jpg"
                      width="540"
                      height="720"
                      loading="lazy"
                      alt="Cherry Red Lipstick"
                  ...
                  <div class="card-content">
                    ...
                    <h3>
                      <a href="product-detail.html?id=59" class="card-title"
                        >NARS Blooming Bliss Lipstain</a
                      >
                    </h3>
                    <div class="card-rating">
                      <div class="rating-wrapper" aria-label="4-star rating">
              ...
              <li class="scrollbar-item">
                <div class="shop-card">
                  ...
                  >
                    <img
                      src="images/lipstain/Avon Barely There.jpg"
                      width="540"
                      height="720"
                      loading="lazy"
                      alt="Coral Kiss Lipstick"
                  ...
                  <div class="card-content">
                    ...
                    <h3>
                      <a href="product-detail.html?id=60" class="card-title"
                        >Avon Barely There Lipstain</a
                      >
                    </h3>
                    <div class="card-rating">
                      <div class="rating-wrapper" aria-label="5-star rating">
