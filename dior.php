        ...
        <section class="section shop" id="all-products" aria-label="all-products" data-section>
          <div class="container">
            <div class="title-wrapper">
              <h2 class="h2 section-title">DIOR</h2>
              ...
              <li class="scrollbar-item">
                <div class="shop-card">
                  ...
                  <div class="card-content">
                    ...
                    <h3>
                      <a href="product-detail.html?id=111" class="card-title">DIOR Crayon Crush</a>
                    </h3>
                    <div class="card-rating">
                      <div class="rating-wrapper" aria-label="4-star rating">
                        <ion-icon name="star" aria-hidden="true"></ion-icon>
            ...
            <ul class="has-scrollbar">
              ...
              <li class="scrollbar-item">
                <div class="shop-card">
                  ...
                  <div class="card-content">
                    ...
                    <h3>
                      <a href="product-detail.html?id=71" class="card-title">Dior Sweet Tint</a>
                    </h3>
                    <div class="card-rating">
                      <div class="rating-wrapper" aria-label="5-star rating">
                        <ion-icon name="star" aria-hidden="true"></ion-icon>
              ...
              <li class="scrollbar-item">
                <div class="shop-card">
                  <div class="card-banner img-holder" style="--width: 540; --height: 720">
                    <img
                      src="images/Satin/Dior Polished Perfection.jpg"
                      width="540"
                      height="720"
                      loading="lazy"
                      alt="Berry Burst Lipstick"
                  ...
                  <div class="card-content">
                    ...
                    <h3>
                      <a href="product-detail.html?id=26" class="card-title"
                        >Dior Polished Perfection Lipstick</a
                      >
                    </h3>
                    <div class="card-rating">
                      <div class="rating-wrapper" aria-label="5-star rating">
              ...
              <li class="scrollbar-item">
                <div class="shop-card">
                  <div class="card-banner img-holder" style="--width: 540; --height: 720">
                    <img
                      src="images/Satin/DIor Shimmering Velvet.jpg"
                      width="540"
                      height="720"
                      loading="lazy"
                  ...
                  <div class="card-content">
                    ...
                    <h3>
                      <a href="product-detail.html?id=29" class="card-title"
                        >DIor Shimmering Velvet Lipstick</a
                      >
                    </h3>
                    <div class="card-rating">
                      <div class="rating-wrapper" aria-label="4-star rating">
